...
![--caption=Hashfunktion --width=80% --align=center --alignCaption=center](img/hash-function.png)
...
<div class="flex">
  ...
  ![--caption="Ein Hashwert ist wie ein Fingerabdruck" --width=70% --align=center --alignCaption=center](img/fingerprint.png)
</div>
