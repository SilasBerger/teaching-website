...
![--width=90% --align=center --alignCaption=center --caption="Symmetrische und asymmetrische Verschlüsselung kombiniert"](img/symm-asymm-encryption.svg)
...
![--width=80% --align=center](img/symm-asymm-encryption-binary.svg)
...
![--width=80% --align=center](img/symm-asymm-decryption-binary.svg)
:::
