...
import XORBlockCipher from "@site/src/app/components/visualization-tools/cryptology/XORBlockCipher";
...
:::Caption
Quelle: _[WhiteTimberwolf, Wikipedia](https://de.wikipedia.org/wiki/Datei:ECB_encryption.svg)_.
:::
...
:::Caption
Quelle: _[WhiteTimberwolf, Wikipedia](https://de.wikipedia.org/wiki/Datei:CBC_encryption.svg)_.
:::
...
:::Caption
Quelle: _[WhiteTimberwolf, Wikipedia](https://de.wikipedia.org/wiki/Datei:CBC_decryption.svg)_.
:::
