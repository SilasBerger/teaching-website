...
<Struktogramm align='flex-start'>
  <Instruction text="Ich gehe ins Bett" />
  <Instruction text="Schafe = 0" />
  <Loop condition="Solange ich wach bin...">
    <Instruction text="Schafe = Schafe + 1" />
  </Loop>
  <Output text="Ausgabe: 💤😴💤" />
</Struktogramm>

<Struktogramm>
  <Input text="Eingabe: a"/>
  <Input text="Eingabe: b"/>
  <Instruction text="c = a + b" />
  <Output text="Ausgabe: c" />
</Struktogramm>

<Struktogramm>
  <Input text="Eingabe: a" />
  <Conditional condition="Wenn a % 2 == 0" truePath={
    <Output text="Ausgabe: 'gerade'" />
  } falsePath={
    <Output text="Ausgabe: 'ungerade'" />
  } />
</Struktogramm>
