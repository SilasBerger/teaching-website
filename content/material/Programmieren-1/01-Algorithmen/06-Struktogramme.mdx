...
<Struktogramm program={[
  ...
  {type: 'step', code: <span>Schafe = 0</span>},
  {type: 'repeat', code: <span>Solange ich wach bin...</span>, block: [
      {type: 'step', code: <span>Schafe = Schafe + 1</span>}
  ]},
  {type: 'output', code: <span>Ausgabe: 💤😴💤</span>},
]} />

<Struktogramm program={[
  {type: 'step', code: <span>a = Zufallszahl(1, 10)</span>},
  {type: 'if', code: <span>Wenn a % 2 == 0</span>, block: [
      {type: 'output', code: <span>Ausgabe: <code>gerade</code></span>}
    ]},
  {type: 'if', code: <span>Sonst</span>, block: [
      {type: 'output', code: <span>Ausgabe: <code>ungerade</code></span>}
    ]}
]} />
