...
![--caption="Variante Kontextmenü" --maxWidth=650px](/img/byod-basics/win11/explorer-new-folder-2.png)
::br
![--caption="Variante Menüband" --maxWidth=650px](/img/byod-basics/win11/explorer-new-folder-1.png)
:::
</TabItem>
<TabItem value="win10">
...
![--caption="Reissverschluss (Zipper)"](/img/byod-basics/zipper.jpg)
...
<OsTabs>
  <TabItem value="win11">
    ![--caption="ZIP Datei" --alignCaption=center --maxWidth=150px](/img/byod-basics/win11/zip_file.jpg)
    <Video src={useBaseUrl('/img/byod-basics/win11/explorer-zip.mp4')} />
  </TabItem>
  <TabItem value="win10">
    ![--caption="ZIP Datei" --alignCaption=center --maxWidth=150px](/img/byod-basics/win/zip_file.jpg)
  ...
  <TabItem value="mac">
    ![--caption="ZIP Datei" --alignCaption=center --maxWidth=150px](/img/byod-basics/osx/zip_file.jpg)
