...
4. Schliessen Sie die Installation ab und öffnen Sie am Schluss das _XAMPP Control Panel_. Sie können dieses auch
...
Die eigene Webseite im Browser öffnen, das konnten Sie auch schon vorher, ohne XAMPP. Da Sie Ihre Webseite aber nun über
einen Web Server im lokalen Netzwerk anbieten, können auch Ihre Kolleginnen und Kollegen darauf zugreifen!

Um die Webseite von jemandem aus Ihrer Klasse anzuschauen, fragen Sie die Person nach ihrer **IP-Adresse**, sowie nach
dem **Namen ihrer HTML-Datei**. Rufen Sie anschliessend die Adresse
