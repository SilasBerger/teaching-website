...
export interface TextDirectiveDeclaration<T extends TextDirectiveTransformerProps> extends LineDirectiveDeclarationBase {
  transform: TextDirectiveTransformer<T>,
}

export interface LeafDirectiveDeclaration<T extends LeafDirectiveTransformerProps> extends LineDirectiveDeclarationBase {
...
export type LeafDirectiveTransformer<T extends LeafDirectiveTransformerProps>
  = (attributes: T) => Optional<MdxJsxFlowElement>
