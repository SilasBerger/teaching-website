import { ImportStatement } from '@mdxeditor/editor';
...
export class MetaDataNode extends DecoratorNode<ReactNode> {
    ...
    getImportDeclarations(): Record<string, ImportStatement> {
        return this.getLatest().__importDeclarations;
    }
    ...
    addOrUpdateImportDeclaration(functionName: string, declaration: ImportStatement) {
        this.getWritable().__importDeclarations = {
