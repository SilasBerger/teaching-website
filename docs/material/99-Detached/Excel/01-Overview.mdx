...
:::insight[Zellen bearbeiten]
Um etwas in eine Zelle einzutragen, klicken Sie auf die Zelle und beginnen zu tippen. Am Schluss drücken Sie __Enter__, um den Inhalt zu speichern.

Um den Inhalt einer Zelle zu bearbeiten, machen Sie einen __:mdi[cursor-default-click] Doppelklick__ auf die Zelle. Wenn Sie die Zelle nur einmal anklicken, wird der Inhalt einfach überschrieben.
:::
