...
**2**
: _Thema aufklappen_
: Dieser Pfeil bedeutet, dass sich hier ein Thema mit mehreren Artikeln handelt.
**3**
: _Breadcrumbs_
: Die Breadcrumbs (dt.: _Brotkrümel_) zeigen an, wo Sie sich gerade befinden (also den Pfad der aktuellen Seite). Mit diesen Knöpfen kann man auch navigieren.
: In diesem Bild befinden wir uns im Artikel __Erste Aufgaben__ im Thema __Willkommen 👋__.
**4**
