...
:mdi[checkbox-blank-outline] : **Offen** : _"Ich habe die Aufgabe noch nicht erledigt."_ :mdi[checkbox-marked-outline]{.green} : **Erledigt** : _"Ich habe die Aufgabe erledigt."_ :mdi[account-question-outline]{.orange} : **Frage** : _"Ich brauche Hilfe von der Lehrperson."_ : Wenn Sie während des Unterrichts eine Frage haben, melden Sie sich trotzdem bei der Lehrperson!
...
:::tip[Arbeitsstand immer aktualisieren] Denken Sie daran, Ihren Arbeitsstand **bei jeder Aufgabe immer zu aktualisieren**. So behalten Sie und die Lehrperson den Überblick über ihren Fortschritt. :::
...
Unten finden Sie einen einfachen kleinen Text-Editor. Er funktioniert wie eine Mini-Version von _Microsoft
Word_ oder _Google Docs_.
...
<Solution id="efa618f0-acf7-4a05-aa91-1a19f4775f31">
    **1. Buchstabe** : A **2. Buchstabe** : B **3. Buchstabe** : C
</Solution>
:::
