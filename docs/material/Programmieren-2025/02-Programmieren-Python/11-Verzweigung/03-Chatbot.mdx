...
Lesen Sie den ganzen Artikel durch. Führen Sie die Beispiele jeweils selbst aus (in VSCode), um sie ausprobieren und nachvollziehen zu können. Sobald Sie bei Schritt 4 angelangt sind, erweitern Sie den Chatbot mit Ihren eigenen Ideen.

:::warning[VSCode verwenden]
In diesem Projekt arbeiten wir mit Endlosschleifen, was in Classrooms nicht sehr gut funktioniert. Arbeiten Sie deshalb am besten in VSCode. Sie können die Beispiele auch dorthin kopieren.
:::
