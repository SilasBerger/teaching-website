...
**Bonus:** Entwickeln Sie das Programm so, dass man in einer Endlosschleife immer wieder ein nächstes Wort eingeben kann. Das geht allerdings nicht in Classrooms. Arbeiten Sie deshalb in VSCode.
