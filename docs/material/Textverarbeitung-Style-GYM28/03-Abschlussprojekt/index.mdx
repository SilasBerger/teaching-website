...
:::dd
  ...
  - **Die Teams entscheiden, ob sie Projekt bewertet und benotet haben möchten.** Die Entscheidung wird zum Zeitpunkt der Abgabe getroffen (via Forms).
  - Wenn das Projekt benotet werden soll, zählt die Note **voll**. Sie werden **als Gruppe** bewertet und erhalten somit die gleiche Note, welche bei allen Gruppenmitgliedern zählt.
  - Wenn das Projekt **nicht** benotet werden soll, entfällt der Teilauftrag «Screencast erstellen».
:::
Fairplay
:::dd
  - **Alle abzugebenden Elemente müssen komplett selbstständig erstellt worden sein.** Die **KI-Generierung** von Text und/oder Code ist ausdrücklich **verboten**. Es dürfen zudem keine vorgefertigten Texte kopiert oder irgendwelche Vorlagen verwendet werden. 
