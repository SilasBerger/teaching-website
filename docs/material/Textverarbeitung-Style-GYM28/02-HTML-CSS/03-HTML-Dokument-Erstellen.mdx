...
Wir Sie in der [Einleitung zu diesem Kapitel](./Texte-im-Web) bereits gelernt haben, können wir mit Thonny nicht nur Python programmieren, sondern auch HTML-Dokumente erstellen. Genau das wollen wir in diesem Abschnitt ausprobieren.
