...
:::key[Werte eines Booleans] Für Boolean-Variablen gibt es nur zwei mögliche Werte: nämlich `True` und `False` (**ohne** Anführungszeichen). :::
...
Vergleichsoperatoren : **Erzeugen** Werte von Typ `bool`. : Beispiele: `<`, `>`, `==`, etc. Boolesche (logische) Operatoren : **Operieren auf** Werten vom Typ `bool`. : Beispiele: `and`, `or`, `not`.
...
<details>
    ...
    <div>
        ...
        <ol>
            <li>
                Das `and` wird vor dem `or` ausgerechnet. `False and False` gibt `False`. Es bleibt: `ergebnis
                = True or False`.
            </li>
...
<details>
    ...
    <div>
        ...
        <ol>
            <li>
                Die Klammern werden zuerst ausgerechnet. `True or False` gibt `True`. Es bleibt: `ergebnis =
                True and False`.
            </li>
...
<details>
    ...
    <div>
        ...
        <ol>
            ...
            <li>
                Das `not` wird vor dem `and` ausgerechnet. `not False` gibt `True`. Es bleibt: `ergebnis =
                True and True`.
            </li>
...
Vervollständigen Sie die Tabelle, indem Sie jeweils den Wahrheitswert (`True` oder `False`) des angegeben
logischen (boolschen) Ausdrucks mit den entsprechenden Variablenwerten ausrechnen.
...
wuerfel_1 = randint(1, 6) print('Erster Würfel: ' + str(wuerfel_1))

wuerfel_2 = randint(1, 6) print('Erster Würfel: ' + str(wuerfel_2))

gewonnen = wuerfel_1 == wuerfel_2 or wuerfel_1 >= 5 and wuerfel_2 >= 5 if gewonnen: print('Gewonnen') else: print('Verloren')
...
if sonne == 'ja' and monat > 2 and monat < 12: print('Keine Jacke nötig.') else: print('Jacke anziehen!')
...
durchschnitt_genuegend = (note_1 + note_2 + note_3) / 3 >= 4 maximal_eine_ungenuegend = (note_1 >= 4 and note_2 >= 4) or (note_1 >= 4 and note_3 >= 4) or (note_2 >= 4 and note_3 >= 4) mindestens_eine_sechs = note_1 == 6 or note_2 == 6 or note_3 == 6 keine_eins = not (note_1 == 1 or note_2 == 1 or note_3 == 1)

bestanden = durchschnitt_genuegend and (maximal_eine_ungenuegend or mindestens_eine_sechs) and keine_eins if bestanden: print('Bestanden') else: print('Nicht bestanden')
