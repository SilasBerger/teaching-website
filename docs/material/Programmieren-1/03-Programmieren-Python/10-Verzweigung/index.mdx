...
Erzeugen Sie für jeden Strich (also für jede Seite des n-Ecks) eine Zufallszahl, mit der Sie dann entscheiden, ob Sie die Stiftfarbe auf rot setzen (z.B. wenn die.
