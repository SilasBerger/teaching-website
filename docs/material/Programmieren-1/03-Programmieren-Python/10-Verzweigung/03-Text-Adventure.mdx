...
:::warning[Thonny verwenden] In diesem Projekt arbeiten wir mit Endlosschleifen. Das funktioniert auf der Webseite nicht sehr gut. Arbeiten Sie deshalb am besten in Thonny: Sie können die Beispiele auch dorthin kopieren. :::
...
:::insight[Falsche Eingaben] Was passiert, wenn wir auf die Frage `Wie geht es dir heute?` nicht mit `gut` oder `schlecht`, sondern z.B. mit `ganz okay` oder `Gut` (mit Grossbuchstaben) antworten?
