...
:::tip[Die richtigen Farben verwenden] Wenn Sie das Bild herunterladen (**:mdi[cursor-default-click] Rechtskick** > **Bild speichern unter...**) und es dann in [diesem Tool](https://imagecolorpicker.com/) hochladen, können Sie mit der Maus auf die verschiedenen Bereiche klicken, um die jeweilige Farbe herauszufinden.
...
:::tip[Kreise und Halbkreise] Schauen Sie sich im [Cheatsheet](../Cheatsheet-Turtle-Befehle) nochmal den Befehl `circle(r, w)` genau an. :::
...
Werden Sie kreativ! Designen Sie auf Papier Ihr eigenes Logo, z.B. für Ihre Klasse, Ihren Sportverein, Ihr
Cookie-Business, ...
