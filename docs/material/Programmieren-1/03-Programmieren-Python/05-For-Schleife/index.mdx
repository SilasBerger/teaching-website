...
:::warning[Auf der Webseite arbeiten] Erledigen Sie alle Aufgaben direkt hier auf der Webseite. Thonny brauchen Sie nicht. :::

::::aufgabe[Aufgabe 1]

<TaskState id="c093bbad-6fff-41b4-9db9-f1bbc6faaeb7" />
Verwenden Sie eine **Schleife**, um mit der Turtle ein regelmässiges Sechseck mit Seitenlänge `100` zu
zeichnen.

:::tip[Zeilen] Ihre Lösung sollte aus maximal 6 Zeilen bestehen (Leerzeilen nicht mitgezählt). :::
...
for i in range(6): forward(100) right(60)
...
for i in range(5): forward(100) left(72)
...
Verwenden Sie eine **Schleife** um eine Treppe mit 7 Stufen zu zeichnen. Die Stufen sollen je 20 Pixel hoch
und tief sein.
...
<String
    id="acc7b8f9-c547-4e8f-a82a-36b16f811c96"
    label="Antwort"
...
for i in range(7): left(90) forward(20) right(90) forward(20)
...
for i in range(8): forward(70) dot(20) back(70) right(360/8)
...
shape('turtle') fillcolor('green')

begin_fill() for i in range(3): left(90) forward(40) right(90) forward(40) end_fill()
...
begin_fill() for i in range(6): forward(100) left(140) forward(100) right(80) end_fill()
...
for i in range(18): forward(100) dot(25) back(100) left(360/18)
...
Wie man mit einer Schleife ein Quadrat zeichnet, wissen Sie bereits. Nun sollen Sie folgendes Bild zeichnen,
welches aus 20 Quadraten (je mit einer Seitenlänge von `100`) besteht, die je 18° zueinander verdreht sind.
...
for i in range(20): for i in range(4): forward(100) right(90) left(18)
...
for i in range(7): for i in range(4): forward(50) right(90) forward(50)
