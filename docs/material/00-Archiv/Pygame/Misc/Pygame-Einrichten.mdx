...
1. Klicken Sie auf _Werkzeuge_ → _Verwalte Pakete_:
   ![--width=500px](img/pygame-einrichten/verwalte-pakete.png)
2. Suchen Sie nach `pygame`:
   ![--width=600px](img/pygame-einrichten/suchen.png)
3. Klicken Sie auf das Paket `pygame`:
   ![--width=600px](img/pygame-einrichten/suchergebnisse.png)
4. Überprüfen Sie nochmal den Namen des Pakets und klicken Sie dann auf _Installieren_:
   ![--width=600px](img/pygame-einrichten/installieren.png)
5. Sobald `pygame` installiert ist, klicken Sie auf _schliessen_:
   ![--width=600px](img/pygame-einrichten/installiert.png)
...
![--width=500px](img/pygame-einrichten/test.png)
