...
:::warning[Voraussetzung] Damit die Kommentarfunktion gebraucht werden kann, braucht es das Plugin [👉 remark-page](../../../app-architecture/remark-plugins/mdx-page/index.mdx). :::
