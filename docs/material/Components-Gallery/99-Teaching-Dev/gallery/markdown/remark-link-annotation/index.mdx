...
Oft ist es hilfreich, Links mit einem zusätzlichen Symbol hervorzuheben: Statt : <a href="#">Link</a> mit Präfix : [👉 Link](#) mit Postfix : <a href="#">Link 🔗</a>
...
:::tip[Keine doppelten Symbole] Ist ein Link bereits händisch annotiert worden, so wird er vom Plugin nicht ein weiteres Mal mit demselben Symbol annotiert. :::
