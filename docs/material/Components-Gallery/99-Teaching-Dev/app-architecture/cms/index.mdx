...
:::warning[WIP] Das CMS ist aktuell noch in der Entwicklungsphase und kann noch Fehler oder Unvollständigkeiten enthalten. :::
...
:::danger[Gelöschte Bilder und Assets] Bilder können ohne überprüfung, ob sie noch in einem Dokument verwendet werden, gelöscht werden. Erst beim Builden der Seite wird dies bemerkt, was je nach Einstelung zu einem fehlerhaften Build führen kann. :::
