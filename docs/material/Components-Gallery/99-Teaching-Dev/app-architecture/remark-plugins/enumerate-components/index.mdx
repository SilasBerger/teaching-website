...
Lorem ipsum dolor sit amet, <TaskState />

consectetur adipiscing elit. <Answers />
```
...
Lorem ipsum dolor sit amet, <TaskState pagePosition={2} />

consectetur adipiscing elit. <Answers pagePosition={3} />
```
