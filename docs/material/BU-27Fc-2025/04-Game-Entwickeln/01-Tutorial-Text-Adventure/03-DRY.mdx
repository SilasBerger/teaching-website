...
:::insight[Sprechender Code] Diese kleine Verbesserung hat noch einen weiteren hübschen Nebeneffekt: Der Code wird gleich viel "sprechender". Beispielsweise können wir die Zeilen `12`-`13` praktisch als Satzfragment lesen: "else ungueltige wahl", also, "andernfalls ist das einen ungültige Wahl". :::
