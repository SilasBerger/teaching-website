...
|----------------|--------------------------------------------------|
| **Click** («Linksclick») | Standard-Click, wird am meisten gebraucht. Zum Beispiel Buttons anclicken, Elemente markieren, etc. |
| **Doppelclick**| Zwei Clicks schnell nacheinander. Wird oft gebraucht, um Dateien und Programme zu öffnen (in der Taskleiste / dem Dock braucht es allerdings nur einen einzelnen Click)  |
...
1. Was passiert, wenn man einen Click (also einen «Linksclick» oder einen «einfachen Click») auf die Datei macht?
...
1. Bei einem **Click** wird die Datei markiert, aber nicht geöffnet. Das ist nützlich, um mehrere Dateien auszuwählen oder um eine Datei zu kopieren oder zu verschieben.
