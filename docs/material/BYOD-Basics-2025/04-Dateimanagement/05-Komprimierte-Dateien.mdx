...
Dateien können *komprimiert* werden - sie brauchen dann **weniger Speicherplatz** auf deinem Gerät, können im Gegenzug aber nicht mehr bearbeitet werden (ausser man entpackt die Dateien wieder).
...
Im Gegensatz zu einem Ordner ist eine ZIP-Datei aber nur eine einzelne Datei. Diese lässt sich **nicht bearbeiten**: Man kann in einer ZIP-Datei also keine neue Datei abspeichern, keinen neuen Ordner erstellen und nichts löschen.
:::
