...
- **Automatisches Speichern**: Die Office-Programme (Word, PowerPoint, Excel) können **automatisch speicher**. Das funktioniert aber nur für Dateien, die **in OneDrive** gespeichert sind.
...
Für Schulaufgaben ist es wichtig, dass du immer in der **Schul**-OneDrive arbeitest. 
