...
## Ordnung halten
Zu LZ: Du kannst Dateien und Ordner sinnvoll benennen und dich dabei auch exakt an etwaige Vorgaben halten (z.B. Gross- und Kleinschreibung, Leerzeichen, Trennstriche, etc.). Du kannst deine Dateien auf deinem Gerät in einer sinnvollen Ordnerstruktur organisieren.
