...
- Du kannst in einem Programm (z.B. Word oder PowerPoint) eine Datei bewusst an einem bestimmten Ort und unter einem bestimmten Namen abspeichern und diese Datei im Dateiexplorer wiederfinden.
- Du kannst Dateien und Ordner sinnvoll benennen und dich dabei auch exakt an etwaige Vorgaben halten (z.B. Gross- und Kleinschreibung, Leerzeichen, Trennstriche, etc.).
