...
3. Erstellen Sie für diesen Ordner einen Link.
   - Wenn Sie nicht mehr wissen, wie man einen Freigabelink erstellt, schauen Sie nochmal im Modul 2, Abschnitt «Cloud» nach.
   ...
   - Senden Sie den Link (z. B. via Teams) einer Kollegin / einem Kollegen zur Kontrolle. Wenn er / sie den Link öffnen kann, damit zum Ordner __Szenarien BYOD__ gelangt, und dort nichts bearbeiten kann, dann sollte alles in Ordnung sein.
