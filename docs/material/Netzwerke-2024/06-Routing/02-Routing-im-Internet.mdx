...
Falls Sie ihr aktuelles Standardgateway noch nicht kennen, dann finden Sie es jetzt heraus. Halten Sie das
Ergebnis für die nächste Aufgabe hier fest.
...
Öffnen Sie eine Eingabeaufforderung (cmd) und geben Sie nacheinander die folgenden drei Befehl ein: ```.sh
title="In der Kommandozeile (cmd)" tracert office.com tracert www.google.ch tracert www.gbsl.ch ``` :::

:::Tab[macOS]{value="macos"} Öffnen Sie eine Eingabeaufforderung (terminal) und geben Sie nacheinander die folgenden drei Befehle ein:
