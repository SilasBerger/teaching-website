...
Und so hat das damals ausgesehen: ![Das "Monochrome" BBS aus den 80er und frühen 90er Jahren](img/bbs.png)
...
<Solution id="e3a4fddd-cfc9-40f3-8756-0ddccf3ae761">
    Jede Benutzer:in hatte ein eigenes Postfach, über das man Nachrichten empfangen konnte (ähnlich wie bei
    E-Mail). Zudem gab es öffentliche Informations-, News-, Diskussions- und Unterhaltungsbereiche, in denen
    man sich austauschen und auf (mehr oder weniger seriöse...) Informationen zugreifen konnte.
</Solution>
:::
