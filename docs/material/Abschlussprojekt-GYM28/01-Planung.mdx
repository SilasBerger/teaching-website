...
4. Geben Sie das fertige Dokument bis **vor dem ersten Schultag nach den Frühlingsferien** als **PDF** mit dem Namen `Projektvertrag_KlasseX_GruppeY.pdf` (also z.B. `Projektvertrag_22Gx_Gruppe4.pdf`) [hier](#) ab. Eine **Unterschrift** ist noch **nicht** notwendig.
