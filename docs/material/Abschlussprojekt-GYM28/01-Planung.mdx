...
<ProgressState id="86dbfc7a-61c9-4a21-bfe3-1019a89155b7">
1. Laden Sie die Word-Vorlage [hier](#) herunter.
2. Speichern Sie das Dokument unter dem Namen `Projektvertrag_KlasseX_GruppeY.docx` ab (ersetzen Sie `KlasseX` und `GruppeY` durch die tatsächlichen Werte, also z.B. `Projektvertrag_22Gx_Gruppe4.docx`). Am besten speichern Sie es gleich im Projektordner Ihrer Gruppe, damit alle Mitglieder Zugriff darauf haben und damit Sie es nicht verlieren.
...
5. Nach den Ferien besprechen Sie den finalen Projektvertrag noch einmal mit der Lehrperson und unterschreiben das Dokument gegenseitig.
</ProgressState>
