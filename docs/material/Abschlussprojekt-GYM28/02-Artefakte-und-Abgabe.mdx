...
Die **termingerechte** und **korrekte** Abgabe (inkl. **Benennung der ZIP-Datei**) fliesst in die Beurteilung mit ein. Die Abgabe ist erst vollständig, wenn die ZIP-Datei korrekt hochgeladen und das Formular ausgefüllt wurde. Es gilt: **Nicht korrekt oder nicht vollständig abgegeben = noch nicht abgegeben**.
:::

Geben Sie Ihr Projekt bis zum angegebenen Zeitpunkt ab, indem **eine Person** wie folgt vorgeht:
<ProgressState id="5c004b17-048f-4919-b5e8-16ebbf932bcd" keepPreviousStepsOpen allOpen>
  ...
  3. Laden Sie die ZIP-Datei unter folgendem Link hoch: [Abgabe Abschlussprojekt](https://erzbe-my.sharepoint.com/:f:/g/personal/silas_berger_gbsl_ch/IgABmoZ80SeTSoUu0sm-qKLGAVsmsOTiMvrhIVoDcI9ZFrw). **Sollte der Link nicht funktionieren, öffnen Sie ihn in einem privaten Browserfenster.**
  ...
  4. Füllen Sie [dieses Formular](https://forms.office.com/Pages/ResponsePage.aspx?id=Y4MGSWGDB0aVSWK2tVeUqneR4FxJ7SlIvbWmmL8iOgxUMUE0V1YwSVVHRlRUMU4yRzhERDhTNkVIRy4u) aus (nur eine Person pro Gruppe!), um anzugeben, ob Sie für Ihr Projekt eine Note wollen oder nicht. Denken Sie daran, dass auch [unbenotete Projekte die Mindestanforderungen für ein genügendes Projekt erreichen müssen](./03-Bewertung.mdx#für-unbenotete-projekte).
</ProgressState>
::::
