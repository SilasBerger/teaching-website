---
page_id: 6ccc214b-829c-4646-9565-6c75a20e7d48
---
...
:::insight[Mehr über CSS-Selektoren] Wenn Sie noch mehr über CSS-Selektoren erfahren möchten, dann schauen Sie sich [diesen Artikel](https://www.w3schools.com/css/css_selectors.asp) an. :::
...
:::warning[Eindeutige IDs] Stellen Sie sich die ID vor wie eine Email-Adresse. Die ID ist dazu da, ein bestimmtes Element im HTML-Dokument eindeutig zu identifizieren. Geanu so, wie keine zwei Personen die gleiche Email-Adresse haben, sollten wir auch nie dieselbe ID im selben Dokument mehr als einmal verwenden. :::
...
<p>In diesem Paragraphen ist nur <span>dieser Bereich grün.</span> Der Rest ist schwarz.</p>
```
...
<html>
    ...
    <body>
        ...
        <p>
            In diesem Paragraphen ist nur <span class="gruener-text">dieser Bereich grün.</span> Der Rest ist
            schwarz.
        </p>
