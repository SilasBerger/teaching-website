...
2. Öffnen Sie die Optionen in Windows Explorer:
   ![--width=500px](img/suffixe-anzeigen/win-optionen.png)
3. Deaktivieren Sie im Reiter _Ansicht_ folgende Option und bestätigen Sie mit _OK_.
   ![--width=500px](img/suffixe-anzeigen/win-option-aktivieren.png)
...
2. Öffnen Sie die Einstellungen im Finder:
   ![--width=400px](img/suffixe-anzeigen/mac-einstellungen.png)
3. Aktivieren Sie die folgende Option:
   ![--width=400px](img/suffixe-anzeigen/mac-option-aktivieren.png)
