...
Die folgende Grafik zeigt den Vigenère-Verschlüsselungsprozess für den Klartext `GEHEIMNIS` mit dem Schlüssel `AKEY`. ![Vigenère-Verschlüsselungsprozess](img/vigenere.png)
