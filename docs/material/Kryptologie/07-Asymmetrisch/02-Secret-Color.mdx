...
:::aufgabe[Aufgabe 1: Geheime Farbe herausfinden] Bestimmen Sie je eine Farbe für Alice und Bob und schauen Sie sich die Ergebnisse an.

Wieso erhalten Alice und Bob schlussendlich dieselbe Farbe? :::

:::aufgabe[Aufgabe 2: Wieso kennt Eve die geheime Farbe nicht?] Überlegen Sie sich: wieso kann Eve aus den verschickten Farben die geheime Farbe nicht herstellen?
