---
page_id: 0225d82f-ea14-4373-8184-ae93464c3030
---
...
🎯 Ziel : Sie verstehen die Problematik hinter dem Fallbeispiel von Anja. : Sie entwickeln ein Lösungskonzept für dieses Problemschema. 🛠️ Material : Laptop : bei Bedarf: Flipchart oder A3-Papier + Stifte (siehe [Vorbereitung](#vorbereitung))
...
<details>
    ...
    <div>
        ### Ein paar Ideen - Party-Einladung(Adresse, Zeit, Kostüm?) - Nachrichten von der Schule(z.B., dass
        eine Lektion ausfällt) - Einverständniserklärung der Eltern - Einladung auf den Minecraft-Server eines
        Freundes (Server-IP)
    </div>
</details>
...
<details>
    ...
    <span>
        Gehen Sie davon aus, dass die Empfänger Anjas Public Key kennen, respektive, diesen bei einer
        vertrauenswürdigen Quelle (z.B. dem Schul-Intranet) nachschauen können.
    </span>
</details>
