...
Wir wollen nun folgendes Spielfenster erzeugen: ![](img/hoehe_breite.png)
...
:::aufgabe[Auftrag] Erstellen Sie jetzt ein neues Python-Programm in Thonny und kopieren Sie den oben stehenden Code dort hinein. Vergewissern Sie sich, dass Sie den Code mit den obigen Erklärungen verstehen.
