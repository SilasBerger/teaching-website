...
Als abschliessende Übung, schauen Sie sich den finalen Code unseres Text Adventures genau an, und überzeugen
Sie sich von folgenden Behauptungen: - Die Riesenspinne ist ein Glückstreffer: Wir kommen auf jeden Fall
weiter, egal ob wir kämpfen oder fliehen. - Sobald wir das Schloss sehen, haben wir das Spiel bereits
verloren. :::
