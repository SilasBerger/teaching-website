...
:::tip[Konfiguration] Falls die Umlaute und das Euro-Zeichen im Hexeditor nicht richtig dargestellt werden, müssen Sie unter **Einstellungen** → **Text-Bereich konfigurieren** → **Zeichensatz** den Zeichensatz `ISO8859-1` auswählen. :::
...
<Solution id="507d60bc-eb0a-4f47-a2bb-2602cb8c4533">
    1. a=61, b=62, c=63, 1=31, 2=32, 3=33, leer=20, ä=E4, Ü=DC, €=80 2. Die Codes `0D 0A` bewirken einen
    Zeilenumbruch. Dies gilt für Windows-Computer. Unter macOS ist es nur der Code `0A`. 3. Python-Programme
    werden als ganz normale Textdateien gespeichert.
</Solution>
:::
