...
:::key[Daten vs. Information] **Merke:** Daten + Kontext = Information. :::
...
:::insight[More information needed] Bei den ersten beiden Beispielen ist streng genommen immer noch nicht klar, um welche Informationen es sich handelt. Die Zahlen könnten Punkte in einem Spiel, Preise für irgendwelche Güter, Messwerte einer physikalische Grösse in einem Experiment, etc. darstellen. :::
