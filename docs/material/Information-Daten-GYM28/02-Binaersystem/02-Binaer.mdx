...
:::warning[Eingabeformat] Die Webseite akzeptiert nur Eingaben im Format $1101010$, also ohne Leerzeichen, Hochstriche, etc., und immer mit einer $1$ an erster Stelle. :::
