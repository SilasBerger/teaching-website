...
Könnten wir dem Dezimalsystem nicht auch noch eine elfte Ziffer hinzufügen? Die Ziffern $0$ bis $9$ sind
schliesslich einfach nur Zeichen, also könnten wir doch ein weiteres Zeichen als zusätzliche Ziffer verwenden:
Zum Beispiel könnten wir sagen, dass $\Omega$ dem Wert "zehn" entsprechen soll, richtig?
...
:::key[Basis und Ziffernvorrat] Bei einem Stellenwertsystem entspricht die Menge der Ziffern im Ziffernvorrat immer der Basis des Systems. So ist zum Beispiel im Dezimalsystem die Basis $10$ (d.h. wir arbeiten mit Potenzen von $10$) und es werden 10 Ziffern verwendet. :::
