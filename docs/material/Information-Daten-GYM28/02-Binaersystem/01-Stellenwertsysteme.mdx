...
Bei einem Stellenwertsystem ist der entspricht die Menge der Ziffern im Ziffernvorrat der Basis des Systems. Die Basis ist die Anzahl Ziffern, die an einer Stelle in einer Zahl vorkommen können. Im Dezimalsystem ist die Basis $10$.
:::
