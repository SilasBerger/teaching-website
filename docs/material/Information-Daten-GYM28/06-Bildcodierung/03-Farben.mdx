...
Versuchen Sie nun im [PBM Viewer](https://www.kylepaulsen.com/stuff/NetpbmViewer/) durch Eingabe der nötigen Zahlen folgendes Bild herzustellen:
...
:::warning[Anzeige im PBM Viewer]
Der PBM Viewer zeigt so kleine Pixelgrafiken nicht ganz sauber an. Sie sollten zwar sechs Quadrate erhalten (ohne schwarzen Rand o.Ä.) aber es ist normal, dass die Grenzen zwischen den Farben etwas verschwommen sind.
:::

Kopieren Sie Ihre Lösung anschliessend hierhin:
<QuillV2 id="1fbb6ddd-87fa-4234-9145-7b82e4d11416" />
