...
3. Verändern Sie jetzt den Wert für `fill` in der **vierten Zeile**. [Hier](https://htmlcolorcodes.com/color-names/) finden Sie eine (nicht abschliessende) Liste mit möglichen Werten. Was verändert sich darurch?
...
TODO: Format aufbauend erklären.
