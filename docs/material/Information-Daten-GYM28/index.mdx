...
<DefinitionList>
  ...
  <dt>Hilfsmittel</dt>
  <dd>Zusammenfassung: 1 Blatt A5, **einseitig** und **handschriftlich** beschrieben</dd>
  <dd>Taschenrechner erlaubt</dd>

  <WithCmsText entries={{punkte: "1e0a5fe6-d833-427e-afeb-8df05f741e23", note: "275b1a92-993a-4704-ab0f-f429c17486bb"}}>
    <dt>Note</dt>
