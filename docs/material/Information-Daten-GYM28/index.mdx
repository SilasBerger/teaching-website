...
<dt>Hilfsmittel</dt>
<dd>
    Zusammenfassung (1 Blatt A5, **einseitig** und **handschriftlich** beschrieben, **persönlich** erstellt)
</dd>
...
:::warning[Lernziel entfernt] Das Lernziel "Sie können Zahlen im Binärsystem addieren" wurde entfernt und ist somit **nicht** prüfungsrelevant. :::
