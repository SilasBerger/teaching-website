...
1. Öffnen Sie in SQLiteStudio einen neuen **SQL-Editor** (über das Symbol mit dem Blatt und dem Bleistift), so dass Sie ein leeres Textfeld für SQL-Abfragen vor sich haben.
...
![--width=500px](img/select_solutions/ganz_bestimmte_legodudes.png)
