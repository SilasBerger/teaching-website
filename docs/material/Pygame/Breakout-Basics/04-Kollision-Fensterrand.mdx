...
:::insight[Rückgabewerte] Was heisst, der Wert wird _zurückgegeben_? Eine Funktion (oder Methode; der Einfachheit halber sprechen wir hier nun lediglich von Funktionen) kann zwei Arten von Aufgaben erfüllen: Sie kann etwas bewirken, oder sie kann einen Wert produzieren.
...
Ausführlichere Informationen zu diesen sogenannten _Rückgabewerten_ finden Sie in [diesem Artikel](../Advanced-Python/Return). :::
