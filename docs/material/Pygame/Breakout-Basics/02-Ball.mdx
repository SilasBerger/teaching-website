...
![--caption="Schematische Darstellung des Rechtecks rund um das Sprite-Bild (Dimensionen nur exemplarisch)" --alignCaption=center](img/rect.png)
...
![--caption="Merke: Koordinate 500,300 bedeutet x=500 und y=300" --alignCaption=center](img/koordinaten.png)
