...
import Skytale from "@site/src/components/visualization-tools/cryptology/Skytale";
...
Probieren Sie die Skytale aus: Verschlüsseln Sie beispielsweise mal Ihren eigenen Namen. Was passiert, wenn Sie den Schlüssel dann von 2 auf 3, 4, 5, ... anpassen?
:::
