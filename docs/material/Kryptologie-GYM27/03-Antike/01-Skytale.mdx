...
Die Skytale ist ein Beispiel einer Verschlüsselung durch Transposition. Das heisst, dass die Zeichen des Geheimtextes nicht ersetzt, sondern nur umgestellt (_transponiert_) werden.
...
<Solution id="e1140ef9-a292-4408-9837-0e9c2f3e1293">
    Der Schlüssel entspricht der Anzahl Kanten der Skytale. Setzen wir den Schlüssel auf $1$, haben wir keine
    Verschlüsselung. Setzen wir ihn auf die Länge des Klartextes, können wir den Klartext vertikal ablesen.
</Solution>
:::
