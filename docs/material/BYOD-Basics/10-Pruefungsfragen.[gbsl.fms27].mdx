...
page_id: 60106b53-2fb0-4b8a-9093-d56a414c76f7
---
...
:::warning[Vorbereitung] Für einige Aufgaben benötigen Sie [diese Prüfungsumgebung](./Pruefungsumgebung).
...
:::aufgabe[Selbstcheck] **Hinweis:** Lesen Sie die Beschreibung zuerst vollständig durch, bevor Sie mit dem Selbstcheck beginnen.
...
:::cards{gap="0.5rem" marginBottom="1rem"} ![Originalbild](/img/byod-basics/osx/sonnenuntergang.jpg) ::br ![Bearbeitetes Bild](/img/byod-basics/osx/sonnenuntergang_edited.jpg) :::

:::danger[Schrift] Beschriftung von Hand (z.B. mit dem Stift) zählt nicht. Die Schriftfarbe und -grösse kann frei gewählt werden, muss aber lesbar sein. :::
