...
page_id: 0d506780-2e87-4e55-84e2-2d3ab97fec21
---
...
<OsTabs>
  ...
  <TabItem value="mac">
    ...
    : Unter den geöffneten Apps zur zuletzt verwendeten wechseln.
    : [[Cmd]] gedrückt lassen: mit [[Tab :mdi[keyboard-tab]]] oder [[Pfeiltasten]] zwischen geöffneten Apps wechseln.
    [[Ctrl]] + [[Tab :mdi[keyboard-tab]]]
    : Zwischen geöffneten Tabs wechseln.
    [[Shift]] + [[Enter :mdi[keyboard-return]]]
    : Neue Zeile im selben Absatz (oder eine neue Zeile in Teams/WhatsApp ohne zu senden)
...
:::tip[(fast) Überall verfügbar] Die meisten Tastenkürzel sind in fast allen Programmen verfügbar.
...
:::aufgabe[Quizz] Lösen Sie das Quizz und markieren Sie die Aufgabe anschliessend als erledigt.

<iframe
    src="https://learningapps.org/watch?app=26314721"
...
:::aufgabe[Shortcuts Tastatur & Pfeiltasten ausprobieren] Probieren Sie die verschiedenen Shortcuts im untenstehenden Textfeld aus!
...
:::aufgabe[Klammern schreiben] Versuchen Sie, alle Klammern selber zu tippen!

<TextBoxPlayground id="d5ed6adf-6331-461f-845f-37b44f28ae31" height="5rem" defaultValue="" />
:::
...
:::aufgabe[Sonderzeichen] Können Sie die obigen Sonderzeichen selber erzeugen? Probieren Sie's hier aus:

<TextBoxPlayground id="f0a4e081-45d8-4d7e-8ba1-1389b4533dda" height="5rem" defaultValue="" />
:::

:::aufgabe[Quizz] Werden Sie Millionär? 🤑💰🤑💰🤑💰

<iframe
    src="https://learningapps.org/watch?app=2815114"
    style={{ border: '0px', width: '100%', height: '500px' }}
    allowFullScreen="true"
    webkitallowfullscreen="true"
    mozallowfullscreen="true"
...
:::aufgabe[🌟 Arcade Game (englisch)] Freiwillig: Spielen Sie das Tastenkürzel-Game
...
<OsTabs>
    <TabItem value="win11">
        Link öffnen (z.B. in Word, Powerpoint, ...) : :mdi[mouse] *Click* oder [[Ctrl]] + :mdi[mouse] *Click*
        (ausprobieren) Link auf einer Webseite in einem neuen Tab öffnen : :mdi[mouse] [[Ctrl]] + *Click*
    </TabItem>
    <TabItem value="win10">
        Link öffnen (z.B. in Word, Powerpoint, ...) : :mdi[mouse] *Click* oder [[Ctrl]] + :mdi[mouse] *Click*
        (ausprobieren) Link auf einer Webseite in einem neuen Tab öffnen : :mdi[mouse] [[Ctrl]] + *Click*
    ...
    <TabItem value="mac">
        Link öffnen (z.B. in Word, Powerpoint, ...) : :mdi[mouse] *Click* oder [[Cmd]] + :mdi[mouse] *Click*
        (ausprobieren) Link auf einer Webseite in einem neuen Tab öffnen : :mdi[mouse] [[Cmd]] + *Click*
    </TabItem>
</OsTabs>
...
(_Diese Option ist nicht bei allen Touchpads verfügbar._)
...
- Durch einfaches _Drag & Drop_ können Programme von einem auf den anderen Desktop verschoben werden.
...
<OsTabs>
    <TabItem value="win11">
        Virtuelle Desktops: Mit [[:mdi[microsoft-windows]]]+[[Tab :mdi[keyboard-tab]]] alle geöffneten Fenster
        anzeigen und oben im Fenster einen neuen Virtuellen Desktop erstellen:
...
<OsTabs>
    <TabItem value="win11">![--width=300px](/img/byod-basics/win/change_virtual_desktops.png)</TabItem>
    <TabItem value="win10">![--width=300px](/img/byod-basics/win/change_virtual_desktops.png)</TabItem>
    <TabItem value="mac">![--width=300px](/img/byod-basics/osx/change_virtual_desktops.png)</TabItem>
</OsTabs>
...
<OsTabs>
    <TabItem value="win11">
        Weitere Gesten finden Sie [👉 :mdi[link]
        hier](https://support.microsoft.com/de-de/windows/touchpad-gesten-f%C3%BCr-windows-10-a9d28305-4818-a5df-4e2b-e5590f850741)
    </TabItem>
    <TabItem value="win10">
        Weitere Gesten finden Sie [👉 :mdi[link]
        hier](https://support.microsoft.com/de-de/windows/touchgesten-f%C3%BCr-windows-a9d28305-4818-a5df-4e2b-e5590f850741#WindowsVersion=Windows_10)
    </TabItem>
    <TabItem value="mac">
